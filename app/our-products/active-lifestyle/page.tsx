...
// Use Quicksand font for consistency
...
const products = [
  {
    ...
    description: "Balanced nutrition for active individuals",
    image:
...
// Matches gradient backgrounds from previous snippets
      ...
      <motion.section className="py-1 pt-32 bg-gradient-to-br from-amber-50 to-orange-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-blue-600 mb-12 max-w-3xl mx-auto">
            Stay hydrated, nourished, and energized with our specially
            formulated products for high-performance athletes.
          </p>
        </div>
      </motion.section>
