...
// Use the same Quicksand font as in earlier snippets
...
const products = [
  {
    ...
    description: "Perfect for creating rich, creamy lattes and cappuccinos",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/mockup-Pacdora-TXZUGh2ksYDaZPaLN0vN08SmYvxNS9.png",
    features: [
  ...
  },
  {
    ...
    description: "Versatile milk perfect for your daily chai or coffee",
    image:
...
// Matching the same gradient logic from the top snippet
...
export default function CoffeeTeaLoverPage() {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      <Navbar />

      <motion.section className="py-1 pt-32 bg-gradient-to-br from-blue-50 to-green-100">
        <div className="container mx-auto px-4">
          <h1
            className={`text-4xl md:text-5xl font-normal text-center text-blue-800 mb-8 ${quicksand.className}`}
          >
            Products for Coffee & Tea Lovers
          </h1>
          <p className="text-xl text-center text-blue-600 mb-12 max-w-3xl mx-auto">
            Elevate your daily brew with our specially crafted milk products,
            designed to enhance the flavor and texture of your favorite coffee
            and tea.
          </p>
        </div>
      </motion.section>
      ...
      {products.map((product, index) => (
        ...
        >
          {/* Wave SVG at the bottom, matching the layering */}
                ...
                >
                  <Link href={`/products/${product.id}`} passHref>
                    <motion.button
                      ...
                      className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white text-lg px-10 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-amber-300"
