...
// Use the same Quicksand font as in the earlier snippets
...
const products = [
  {
    ...
    description: "Rich and creamy milk for the whole family",
    image:
  ...
  },
  {
    ...
    description: "Balanced nutrition for growing children and adults",
    image:
...
// Matching the gradient color approach from the top snippet
...
export default function FamilyHomemakerPage() {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <motion.section className="py-1 pt-32 bg-gradient-to-br from-blue-50 to-green-100">
        <div className="container mx-auto px-4">
          ...
          >
            Products for Families & Homemakers
          </h1>
          <p className="text-xl text-center text-blue-600 mb-12 max-w-3xl mx-auto">
            Versatile, nutritious options to nourish and support your entire
            family's well-being.
          </p>
        </div>
      </motion.section>
      ...
      {products.map((product, index) => (
        ...
        >
          {/* Same bottom wave from previous examples */}
          ...
          <div className="container mx-auto px-4 py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                {/* Single "Learn More" button, removing "Find Near You" */}
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
