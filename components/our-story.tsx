        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <motion.h2
              ...
              className="text-3xl md:text-4xl font-bold text-unblend-navy"
            >
              Our Story
            </motion.h2>
            <motion.p
            ...
            <motion.div variants={itemVariants} className="pt-4">
              <Link href="/our-story">
                <Button className="w-full sm:w-auto bg-unblend-navy hover:bg-unblend-navy/90 text-white group">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-4">
                <motion.div
                  variants={itemVariants}
                  className="bg-unblend-blue/10 p-4 md:p-6 rounded-xl"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-unblend-navy mb-2">
                    Legacy of Nourishment
                  </h3>
                  <p className="text-sm md:text-base text-gray-600">
                    Milk is a symbol of care, strength, and tradition.
                  </p>
                </motion.div>
                <motion.div
                  variants={itemVariants}
